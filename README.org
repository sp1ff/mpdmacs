...
#+BEGIN_SRC elisp
  (package-install-file "mpdmacs-1.0.1.tar")
#+END_SRC

The Github [[https://github.com/sp1ff/mpdmacs/releases][releases]] also include Autotools source tarballs:

#+BEGIN_SRC bash
  curl -L -O https://github.com/sp1ff/mpdmacs/releases/download/1.0.1/mpdmacs-1.0.1.tar.gz
  tar xf mpdmacs-1.0.1.tar.gz && cd mpdmacs-1.0.1
